...
template <typename T> struct pid_controller
{
    T kp, ki, kd;
    ...
    pid_controller(T kp, T ki, T kd, T sum_error_max, T p_max, T i_max,
                   T output_max);
...
template <typename T> struct pid_angle_velocity_controller
{
