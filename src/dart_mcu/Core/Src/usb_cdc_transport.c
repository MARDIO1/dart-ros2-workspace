...
#include <unistd.h>
    ...
    static int8_t CDC_TransmitCplt_FS(uint8_t *Buf, uint32_t *Len,
                                      uint8_t epnum);
    ...
    // Line coding: Rate: 115200bps; CharFormat: 1 Stop bit; Parity: None; Data:
    // 8 bits
...
#define WRITE_TIMEOUT_MS 100U
    ...
    bool cubemx_transport_open(struct uxrCustomTransport *transport)
    {
        ...
        if (!initialized)
        {
            // USB is initialized on generated main code: Replace default
            // callbacks here
