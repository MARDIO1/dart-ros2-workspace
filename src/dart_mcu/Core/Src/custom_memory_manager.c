/*
 * A custom implementation of pvPortMallocMicroROS() and vPortFreeMicroROS()
 * with realloc and calloc features based on FreeRTOS heap4.c.
 */
...
size_t xPortGetFreeHeapSizeMicroROS(void) { return xFreeBytesRemaining; }
/*-----------------------------------------------------------*/
